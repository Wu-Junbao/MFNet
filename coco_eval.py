...
ap.add_argument('-w', '--weights', type=str, default='./weights/efficientdet-d0_28_val.pth', help='/path/to/weights')
...
params = yaml.safe_load(open(f'projects/{project_name}.yml',encoding='utf-8'))
...
if __name__ == '__main__':
    ...
    VAL_GT = f'G:/code/dataset/{params["project_name"]}/annotations/instances_{SET_NAME}.json'
    VAL_IMGS = f'G:/code/dataset/{params["project_name"]}/{SET_NAME}/'
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
